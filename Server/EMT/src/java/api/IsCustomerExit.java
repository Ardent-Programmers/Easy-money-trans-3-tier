 ...
 * @author User
 */
@WebServlet(name = "IsCustomerExit", urlPatterns = {"/IsCustomerExit"})
public class IsCustomerExit extends HttpServlet {
    ...
    //        checking login status
            boolean isExist = ServerManager.databaseManager.getCdao().isCustomerExist(accNo);
